		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="product-info-cont" id="product-info-cont">
					<span class="product-title">R9s 玫瑰金 前后1600万像素</span>
					...
					<div class="product-color">
						...
						<div class="product-colorcont">
							<a href="../1-1/index.php" style="text-decoration: none;"><span class="product-color1">金色</span></a>
							<span class="product-color2">玫瑰金</span>
							<a href="../1-3/index.php" style="text-decoration: none;"><span class="product-color3">黑色</span></a>
						</div>
					</div>
