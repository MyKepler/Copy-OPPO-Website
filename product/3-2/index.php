 ...
 <a href="../../oppo-index.php" style='text-decoration:none;'>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="product-info-cont" id="product-info-cont">
					<span class="product-title">A57 金色 1600万美颜自拍</span>
					<span class="product-name-extra">
						前置1600万像素，正面指纹识别，3GB运存+32GB内存，2900mAh大电池
					</span>
					<span class="product-price">￥1599.00</span>
					<div class="product-color">
						<span>颜色</span>
						<div class="product-colorcont">
							<a href="../3-1/index.php" style="text-decoration: none;"><span class="product-color1">玫瑰金</span></a>
							<span class="product-color2">金色</span>
							<a href="../3-3/index.php" style="text-decoration: none;"><span class="product-color3">黑色</span></a>
						</div>
					</div>
	...
	<div class="product-details" id="product-details">
		...
		<img src="img/商品详情1.jpg" alt="" class="product-details1"> 
			...
			<img src="img/商品详情10.jpg" alt="" class="product-details10"> 
			<img src="img/商品详情11.jpg" alt="" class="product-details11">
			<img src="img/商品详情12.jpg" alt="" class="product-details12">
			<img src="img/商品详情13.jpg" alt="" class="product-details13"></div>
		...
		<div class="product-standard" id="product-standard">
			<div class="row">  
				...
				<img src="img/规格参数14.jpg" alt="">  </div>
