		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="product-info-cont" id="product-info-cont">
					<span class="product-title">OPPO时尚单品自拍杆 晴空蓝</span>
					<span class="product-price">￥39.00</span>
					<div class="product-color">
						<span>颜色</span>
						<div class="product-colorcont">
							<span class="product-color1">晴空蓝</span>
							<a href="../11-2/index.php" style="text-decoration: none;"><span class="product-color2">樱花粉</span></a>
						</div>
					</div>
