 ...
 */
 ...
 function init() {
 	...
 	$(".product-color3").css("border-color","#2aad6f");
  productcolor3();
...
function productcolor1(e) {
  ...
  $(".product-details13").attr("src","img/商品详情13.jpg");
...
function productcolor3(e){
  ...
  $("#product-smallimg3").css("border-color","#f2f2f2");
  $("#product-smallimg4").css("border-color","#f2f2f2");
  $(".product-bigimg").attr("src","img/3-1.png");
  $("#product-smallimg1").attr("src","img/3-1.png");
  $("#product-smallimg2").attr("src","img/3-2.png");
  $("#product-smallimg3").attr("src","img/3-3.png");
  $("#product-smallimg4").attr("src","img/3-4.png");
  $(".product-details1").attr("src","img/商品详情3-1.jpg");
  $(".product-details2").attr("src","img/商品详情3-2.jpg");
  $(".product-details3").attr("src","img/商品详情3-3.jpg");
  $(".product-details4").attr("src","img/商品详情3-4.jpg");
  $(".product-details5").attr("src","img/商品详情3-5.jpg");
  $(".product-details6").attr("src","img/商品详情10.jpg");
  $(".product-details7").hide();
  $(".product-details8").hide();
  $(".product-details9").hide();
  $(".product-details10").hide();
