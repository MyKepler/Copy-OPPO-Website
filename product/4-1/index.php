 ...
 <a href="../../oppo-index.php" style='text-decoration:none;'>
	...
	<div class="row" id="header-after">
		...
		<div class="col-md-5">
			<div class="header-after-spancont">
				...
				<span>商品列表</span>
				<span>/</span>
				<span>A59s 玫瑰金 1600万金属自拍神器</span>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="product-info-cont" id="product-info-cont">
					<span class="product-title">A59s 金色 1600万金属自拍神器</span>
					...
					<div class="product-color">
						...
						<div class="product-colorcont">
							...
							<a href="../4-2/index.php" style="text-decoration: none;"><span class="product-color2">玫瑰金</span></a>
						</div>
					</div>
	...
	<div class="product-details" id="product-details">
		...
		<img src="img/商品详情1.jpg" alt="" class="product-details1"> 
			...
			<img src="img/商品详情12.jpg" alt="" class="product-details12"></div>
