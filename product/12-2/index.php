		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="product-info-cont" id="product-info-cont">
					<span class="product-title">R9s 液态硅胶保护壳 白色</span>
					<span class="product-price">￥49.00</span>
					<div class="product-color">
						<span>颜色</span>
						<div class="product-colorcont">
							<a href="../12-1/index.php" style="text-decoration: none;"><span class="product-color1">河畔蓝</span></a>
							<span class="product-color2">白色</span>
						</div>
					</div>
